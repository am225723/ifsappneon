...
export default function PrototypeIFSLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-body-md text-on-surface relative overflow-x-hidden bg-[#060e20]">
      ...
      <header className="flex flex-col items-center justify-center w-full px-margin-mobile pt-12 z-10 relative pointer-events-none">
        <div className="flex flex-col items-center gap-2 bg-[#002022]/40 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl">
          <img alt="IFS Healing Phoenix Logo" className="w-[230px] h-auto floating-element drop-shadow-[0_0_25px_rgba(197,160,89,0.6)]" id="gravity-center" src={LOGO_URL} />
          <h1 className="font-display-xl text-headline-lg-mobile md:text-display-xl text-on-surface drop-shadow-lg text-center leading-tight mt-2">IFS Healing</h1>
          <p className="font-handwritten text-on-surface text-lg tracking-widest uppercase drop-shadow-md">THE LUMINOUS SELF</p>
        </div>
      </header>

      <main className="flex-grow flex flex-col items-center justify-center px-margin-mobile py-12 relative z-10">
        <div className="max-w-md w-full bg-[#002022]/60 backdrop-blur-xl p-8 md:p-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] relative border border-white/10 tilt-1 rounded-2xl">
          ...
          <div className="space-y-8">
            <div className="text-center">
              <p className="font-handwritten text-xl text-on-surface drop-shadow-md">Meeting Your Parts,</p>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button disabled={!isLoaded || isSubmitting} className="w-full relative group overflow-hidden py-4 px-8 rounded-lg transition-all duration-500 hover:scale-[1.02] active:scale-95 shadow-xl tilt-n1 border border-white/10 disabled:opacity-60" type="submit">
                ...
                <span className="relative z-10 font-display-xl text-2xl text-white tracking-wide flex items-center justify-center gap-2 drop-shadow-md">
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
              <a className="font-handwritten text-on-surface/90 hover:text-on-surface transition-colors cursor-pointer-hand drop-shadow-sm" href="/sign-in">Lost your key?</a>
